...
# Main solicitudes table: 100 rows at a time.
...
# RABA03 table: progressive preview only; full raba03DownloadRows remains intact for exports.
...
# Remitos cargados: 100 remitos at a time.
...
print('Applied 100-row progressive loading to Solicitudes, RABA03 and Remitos.')